    ...
    <>
      ...
      <div className="flex flex-col min-h-screen justify-center items-center">
        <div className="flex flex-row justify-center items-center">
          <h1 className="font-extrabold text-2xl bg-clip-text md:text-5xl sm:text-1xl">
            Custom skincare routines&#160;
          </h1>
          <h1 className="font-extrabold text-transparent text-2xl bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600 md:text-5xl sm:text-1xl">
            powered by AI.
          </h1>
          {/* <h1 className="text-8xl ml-5">🧖🏻‍♀️</h1> */}
        </div>
        <div className="flex flex-col items-center">
          <h2 className="flex flex-col items-center justify-center mt-10 md:text-2xl sm:text-1xl text-1xl">
